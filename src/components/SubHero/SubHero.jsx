...
const SubHero = ({ title, text, boldTitle }) => {
  return (
    <div className="relative z-10">
      <div
        ...
        style={{
          backgroundImage: `url('${images.subHeroBg}')`,
      ...
      >
        ...
        <div className="p-6 h-full w-full flex flex-col justify-center items-center gap-6 min-[1400px]:mt-8 xl:mt-0 lg:mt-10">
          ...
          <div>
            <h3 className="text-white lg:text-5xl md:text-4xl text-3xl leading-tight text-center">
