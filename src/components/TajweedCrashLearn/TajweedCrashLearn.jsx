...
const TajweedCrashLearn = () => {
  ...
  return (
    <div className="w-full px-6 lg:py-12 py-6 bg-no-repeat lg:bg-top bg-center bg-cover overflow-hidden relative bg-[#EAF0F3]">
      <div className="max-w-[1600px] mx-auto flex lg:flex-row lg:justify-between items-center lg:gap-8">
        <div className="flex flex-col xl:gap-8 gap-6">
          ...
          <div>
            <h3 className="min-[1400px]:text-4xl xl:text-4xl lg:text-3xl md:text-4xl text-3xl max-w-md">
              What You Will Learn in This{" "}
              <span className="poppins-bold">Course?</span>
            </h3>
          </div>
...
export default TajweedCrashLearn;
