...
const Footer = () => {
  return (
    ...
    <div className="w-full px-6 pt-10 pb-6 bg-footerBg relative ">
      ...
      <div className="max-w-[1600px] mx-auto ">
        ...
        <div className="grid lg:grid-cols-4 sm:grid-cols-2 grid-cols-1 xl:gap-12 gap-6">
          <div className="flex flex-col gap-6">
            <a href={"/"}>
              <img
                ...
                alt=""
                className="xl:w-36 w-32 object-contain"
              />
            </a>
            <div>
              <p className="text-white max-w-[300px] min-[1400px]:text-base text-sm">
          ...
          <div className="flex flex-col sm:gap-8 gap-8">
            <div className="relative">
              <h3 className="text-white min-[1400px]:text-xl text-lg font-semibold">
                Quick Links
              </h3>
          ...
          <div className="flex flex-col sm:gap-12 gap-8">
            ...
            <div className="flex flex-col gap-4">
              <div className="flex flex-row gap-3 items-center">
                ...
                <p className="text-white min-[1400px]:text-base text-sm">
                  +44 20 3289 4228
                </p>
              </div>
              <div className="flex flex-row gap-3 items-center">
              ...
              <div className="flex flex-row gap-3 items-center">
                ...
                <p className="text-white min-[1400px]:text-base text-sm max-w-[280px]">
        ...
        <div className="mt-6">
          <p className="text-white min-[1400px]:text-base text-sm text-center">
